                  ...
                  <DialogTrigger className="w-full h-full cursor-pointer group">
                    <div className="relative p-4 h-full">
                      ...
                      <div className="relative flex flex-col items-center">
                        <img className="mx-auto h-32 w-32 rounded-full object-cover border-2 border-accent/50 group-hover:border-primary/70 transition-all duration-300" src={person.imageUrl} alt={`Foto ${person.name}`} />
